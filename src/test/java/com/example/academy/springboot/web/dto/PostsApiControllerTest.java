...
public class PostsApiControllerTest {
    ...
    public void registerPosts() throws Exception {
        ...
        PostsSaveRequestDto requestDto = PostsSaveRequestDto.builder().title(title).content(content).author("aron@test.com").build();
    ...
    public void updatePosts() throws Exception {
        ...
        Posts savedPosts = postsRepository.save(Posts.builder().title(expectedTitle).content(expectedContent).author("aron@test.com").build());
